...
export function CardSkeleton() {
  return (
    <div className="bg-slate-900/40 border border-slate-800/60 p-5 rounded-2xl flex flex-col justify-between h-36">
...
export function NotificationSkeleton() {
  return (
    <div className="space-y-3">
      {[1, 2, 3].map((i) => (
        <div key={i} className="p-3.5 rounded-xl bg-slate-900/30 border border-slate-800/40 flex gap-3 items-start">
...
export function TaskListSkeleton() {
  return (
    <div className="space-y-3">
      {[1, 2, 3].map((i) => (
        <div key={i} className="p-4 rounded-xl bg-slate-900/40 border border-slate-800/40 flex items-center justify-between">
...
export function StudyPlanSkeleton() {
  return (
    <div className="space-y-6">
      <div className="p-6 rounded-2xl bg-slate-900/40 border border-slate-800/50 space-y-3">
        <SkeletonPulse className="w-24 h-4" />
